...
createTicketAttachment :: forall m . Linode.Common.MonadHTTP m => GHC.Types.Int -- ^ ticketId: The ID of the Support Ticket.
  -> Linode.Common.ClientT m (Network.HTTP.Client.Types.Response CreateTicketAttachmentResponse) -- ^ Monadic computation which returns the result of the operation
createTicketAttachment ticketId = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either CreateTicketAttachmentResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> CreateTicketAttachmentResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
...
data CreateTicketAttachmentResponse =
  ...
  | CreateTicketAttachmentResponse200 Data.Aeson.Types.Internal.Object -- ^ Attachment created.
...
data CreateTicketAttachmentResponseBodyDefault = CreateTicketAttachmentResponseBodyDefault {
  -- | errors
  createTicketAttachmentResponseBodyDefaultErrors :: (GHC.Maybe.Maybe ([ErrorObject]))
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON CreateTicketAttachmentResponseBodyDefault
    where toJSON obj = Data.Aeson.Types.Internal.object ("errors" Data.Aeson.Types.ToJSON..= createTicketAttachmentResponseBodyDefaultErrors obj : GHC.Base.mempty)
          toEncoding obj = Data.Aeson.Encoding.Internal.pairs ("errors" Data.Aeson.Types.ToJSON..= createTicketAttachmentResponseBodyDefaultErrors obj)
...
-- | Create a new 'CreateTicketAttachmentResponseBodyDefault' with all required fields.
mkCreateTicketAttachmentResponseBodyDefault :: CreateTicketAttachmentResponseBodyDefault
mkCreateTicketAttachmentResponseBodyDefault = CreateTicketAttachmentResponseBodyDefault{createTicketAttachmentResponseBodyDefaultErrors = GHC.Maybe.Nothing}
