...
deleteSSHKey :: forall m . Linode.Common.MonadHTTP m => GHC.Types.Int -- ^ sshKeyId: The ID of the SSHKey
  -> Linode.Common.ClientT m (Network.HTTP.Client.Types.Response DeleteSSHKeyResponse) -- ^ Monadic computation which returns the result of the operation
deleteSSHKey sshKeyId = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either DeleteSSHKeyResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> DeleteSSHKeyResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
...
data DeleteSSHKeyResponse =
  ...
  | DeleteSSHKeyResponse200 Data.Aeson.Types.Internal.Object -- ^ SSH Key deleted successfully.
...
data DeleteSSHKeyResponseBodyDefault = DeleteSSHKeyResponseBodyDefault {
  -- | errors
  deleteSSHKeyResponseBodyDefaultErrors :: (GHC.Maybe.Maybe ([ErrorObject]))
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON DeleteSSHKeyResponseBodyDefault
    where toJSON obj = Data.Aeson.Types.Internal.object ("errors" Data.Aeson.Types.ToJSON..= deleteSSHKeyResponseBodyDefaultErrors obj : GHC.Base.mempty)
          toEncoding obj = Data.Aeson.Encoding.Internal.pairs ("errors" Data.Aeson.Types.ToJSON..= deleteSSHKeyResponseBodyDefaultErrors obj)
...
-- | Create a new 'DeleteSSHKeyResponseBodyDefault' with all required fields.
mkDeleteSSHKeyResponseBodyDefault :: DeleteSSHKeyResponseBodyDefault
mkDeleteSSHKeyResponseBodyDefault = DeleteSSHKeyResponseBodyDefault{deleteSSHKeyResponseBodyDefaultErrors = GHC.Maybe.Nothing}
