...
getProfile :: forall m . Linode.Common.MonadHTTP m => Linode.Common.ClientT m (Network.HTTP.Client.Types.Response GetProfileResponse) -- ^ Monadic computation which returns the result of the operation
getProfile = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetProfileResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetProfileResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                            Profile)
                                                                                                                                                  ...
                                                                                                                                                  | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (Linode.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "GET") (Data.Text.pack "/profile") GHC.Base.mempty)
...
data GetProfileResponseBodyDefault = GetProfileResponseBodyDefault {
  -- | errors
  getProfileResponseBodyDefaultErrors :: (GHC.Maybe.Maybe ([ErrorObject]))
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetProfileResponseBodyDefault
    where toJSON obj = Data.Aeson.Types.Internal.object ("errors" Data.Aeson.Types.ToJSON..= getProfileResponseBodyDefaultErrors obj : GHC.Base.mempty)
          toEncoding obj = Data.Aeson.Encoding.Internal.pairs ("errors" Data.Aeson.Types.ToJSON..= getProfileResponseBodyDefaultErrors obj)
...
-- | Create a new 'GetProfileResponseBodyDefault' with all required fields.
mkGetProfileResponseBodyDefault :: GetProfileResponseBodyDefault
mkGetProfileResponseBodyDefault = GetProfileResponseBodyDefault{getProfileResponseBodyDefaultErrors = GHC.Maybe.Nothing}
