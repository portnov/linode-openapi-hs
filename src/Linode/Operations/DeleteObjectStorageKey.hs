...
deleteObjectStorageKey :: forall m . Linode.Common.MonadHTTP m => GHC.Types.Int -- ^ keyId: The key to look up.
  -> Linode.Common.ClientT m (Network.HTTP.Client.Types.Response DeleteObjectStorageKeyResponse) -- ^ Monadic computation which returns the result of the operation
deleteObjectStorageKey keyId = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either DeleteObjectStorageKeyResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> DeleteObjectStorageKeyResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                ...
                                                                                                                                                                                | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (Linode.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "DELETE") (Data.Text.pack ("/object-storage/keys/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ Linode.Common.stringifyModel keyId)) GHC.Base.++ ""))) GHC.Base.mempty)
...
data DeleteObjectStorageKeyResponse =
  ...
  | DeleteObjectStorageKeyResponse200 Data.Aeson.Types.Internal.Object -- ^ Deletion successful
...
data DeleteObjectStorageKeyResponseBodyDefault = DeleteObjectStorageKeyResponseBodyDefault {
  -- | errors
  deleteObjectStorageKeyResponseBodyDefaultErrors :: (GHC.Maybe.Maybe ([ErrorObject]))
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON DeleteObjectStorageKeyResponseBodyDefault
    where toJSON obj = Data.Aeson.Types.Internal.object ("errors" Data.Aeson.Types.ToJSON..= deleteObjectStorageKeyResponseBodyDefaultErrors obj : GHC.Base.mempty)
          toEncoding obj = Data.Aeson.Encoding.Internal.pairs ("errors" Data.Aeson.Types.ToJSON..= deleteObjectStorageKeyResponseBodyDefaultErrors obj)
...
-- | Create a new 'DeleteObjectStorageKeyResponseBodyDefault' with all required fields.
mkDeleteObjectStorageKeyResponseBodyDefault :: DeleteObjectStorageKeyResponseBodyDefault
mkDeleteObjectStorageKeyResponseBodyDefault = DeleteObjectStorageKeyResponseBodyDefault{deleteObjectStorageKeyResponseBodyDefaultErrors = GHC.Maybe.Nothing}
