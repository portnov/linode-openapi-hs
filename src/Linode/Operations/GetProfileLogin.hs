...
getProfileLogin :: forall m . Linode.Common.MonadHTTP m => GHC.Types.Int -- ^ loginId: The ID of the login object to access.
  -> Linode.Common.ClientT m (Network.HTTP.Client.Types.Response GetProfileLoginResponse) -- ^ Monadic computation which returns the result of the operation
getProfileLogin loginId = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetProfileLoginResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetProfileLoginResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                   Login)
                                                                                                                                                                    ...
                                                                                                                                                                    | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (Linode.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "GET") (Data.Text.pack ("/profile/logins/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ Linode.Common.stringifyModel loginId)) GHC.Base.++ ""))) GHC.Base.mempty)
...
data GetProfileLoginResponseBodyDefault = GetProfileLoginResponseBodyDefault {
  -- | errors
  getProfileLoginResponseBodyDefaultErrors :: (GHC.Maybe.Maybe ([ErrorObject]))
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetProfileLoginResponseBodyDefault
    where toJSON obj = Data.Aeson.Types.Internal.object ("errors" Data.Aeson.Types.ToJSON..= getProfileLoginResponseBodyDefaultErrors obj : GHC.Base.mempty)
          toEncoding obj = Data.Aeson.Encoding.Internal.pairs ("errors" Data.Aeson.Types.ToJSON..= getProfileLoginResponseBodyDefaultErrors obj)
...
-- | Create a new 'GetProfileLoginResponseBodyDefault' with all required fields.
mkGetProfileLoginResponseBodyDefault :: GetProfileLoginResponseBodyDefault
mkGetProfileLoginResponseBodyDefault = GetProfileLoginResponseBodyDefault{getProfileLoginResponseBodyDefaultErrors = GHC.Maybe.Nothing}
