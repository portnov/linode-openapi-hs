...
deleteFirewall :: forall m . Linode.Common.MonadHTTP m => GHC.Types.Int -- ^ firewallId: ID of the Firewall to access. 
  -> Linode.Common.ClientT m (Network.HTTP.Client.Types.Response DeleteFirewallResponse) -- ^ Monadic computation which returns the result of the operation
deleteFirewall firewallId = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either DeleteFirewallResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> DeleteFirewallResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
...
data DeleteFirewallResponse =
  ...
  | DeleteFirewallResponse200 Data.Aeson.Types.Internal.Object -- ^ Delete Successful.
...
data DeleteFirewallResponseBodyDefault = DeleteFirewallResponseBodyDefault {
  -- | errors
  deleteFirewallResponseBodyDefaultErrors :: (GHC.Maybe.Maybe ([ErrorObject]))
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON DeleteFirewallResponseBodyDefault
    where toJSON obj = Data.Aeson.Types.Internal.object ("errors" Data.Aeson.Types.ToJSON..= deleteFirewallResponseBodyDefaultErrors obj : GHC.Base.mempty)
          toEncoding obj = Data.Aeson.Encoding.Internal.pairs ("errors" Data.Aeson.Types.ToJSON..= deleteFirewallResponseBodyDefaultErrors obj)
...
-- | Create a new 'DeleteFirewallResponseBodyDefault' with all required fields.
mkDeleteFirewallResponseBodyDefault :: DeleteFirewallResponseBodyDefault
mkDeleteFirewallResponseBodyDefault = DeleteFirewallResponseBodyDefault{deleteFirewallResponseBodyDefaultErrors = GHC.Maybe.Nothing}
