...
getAccountSettings :: forall m . Linode.Common.MonadHTTP m => Linode.Common.ClientT m (Network.HTTP.Client.Types.Response GetAccountSettingsResponse) -- ^ Monadic computation which returns the result of the operation
getAccountSettings = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetAccountSettingsResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetAccountSettingsResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                    AccountSettings)
                                                                                                                                                                  ...
                                                                                                                                                                  | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (Linode.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "GET") (Data.Text.pack "/account/settings") GHC.Base.mempty)
...
data GetAccountSettingsResponseBodyDefault = GetAccountSettingsResponseBodyDefault {
  -- | errors
  getAccountSettingsResponseBodyDefaultErrors :: (GHC.Maybe.Maybe ([ErrorObject]))
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetAccountSettingsResponseBodyDefault
    where toJSON obj = Data.Aeson.Types.Internal.object ("errors" Data.Aeson.Types.ToJSON..= getAccountSettingsResponseBodyDefaultErrors obj : GHC.Base.mempty)
          toEncoding obj = Data.Aeson.Encoding.Internal.pairs ("errors" Data.Aeson.Types.ToJSON..= getAccountSettingsResponseBodyDefaultErrors obj)
...
-- | Create a new 'GetAccountSettingsResponseBodyDefault' with all required fields.
mkGetAccountSettingsResponseBodyDefault :: GetAccountSettingsResponseBodyDefault
mkGetAccountSettingsResponseBodyDefault = GetAccountSettingsResponseBodyDefault{getAccountSettingsResponseBodyDefaultErrors = GHC.Maybe.Nothing}
