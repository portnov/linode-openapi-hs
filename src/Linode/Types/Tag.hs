...
data Tag = Tag {
  ...
  tagLabel :: (GHC.Base.Maybe Data.Text.Internal.Text)
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.ToJSON Tag
    where toJSON obj = Data.Aeson.object ((Data.Aeson..=) "label" (tagLabel obj) : [])
          toEncoding obj = Data.Aeson.pairs ((Data.Aeson..=) "label" (tagLabel obj))
