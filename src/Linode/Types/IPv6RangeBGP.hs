...
data IPv6RangeBGP = IPv6RangeBGP {
  ...
  , iPv6RangeBGPPrefix :: (GHC.Base.Maybe GHC.Integer.Type.Integer)
  -- | range: The IPv6 range of addresses in this pool.
  , iPv6RangeBGPRange :: (GHC.Base.Maybe Data.Text.Internal.Text)
  -- | region: The region for this range of IPv6 addresses.
  , iPv6RangeBGPRegion :: (GHC.Base.Maybe Data.Text.Internal.Text)
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.ToJSON IPv6RangeBGP
    where toJSON obj = Data.Aeson.object ((Data.Aeson..=) "is_bgp" (iPv6RangeBGPIs_bgp obj) : (Data.Aeson..=) "linodes" (iPv6RangeBGPLinodes obj) : (Data.Aeson..=) "prefix" (iPv6RangeBGPPrefix obj) : (Data.Aeson..=) "range" (iPv6RangeBGPRange obj) : (Data.Aeson..=) "region" (iPv6RangeBGPRegion obj) : [])
          toEncoding obj = Data.Aeson.pairs ((Data.Aeson..=) "is_bgp" (iPv6RangeBGPIs_bgp obj) GHC.Base.<> ((Data.Aeson..=) "linodes" (iPv6RangeBGPLinodes obj) GHC.Base.<> ((Data.Aeson..=) "prefix" (iPv6RangeBGPPrefix obj) GHC.Base.<> ((Data.Aeson..=) "range" (iPv6RangeBGPRange obj) GHC.Base.<> (Data.Aeson..=) "region" (iPv6RangeBGPRegion obj)))))
